...
from mouse_utils import MouseTracker
...
if __name__ == '__main__':
    ...
    print("\nClick custom start and end points for the REVERSED trajectory! Remember this will be the reversed trajectory generated by the DMP from the provided demo.")
